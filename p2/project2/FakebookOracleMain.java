...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "cnrusimh"; // replace with your uniqname
    private static String password = "Amphicoelias1"; // replace with your Oracle password (default: eecsclass)
