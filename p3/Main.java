...
public class Main {
    ...
    static String oracleUserName = "cnrusimh"; // replace with your uniqname
    static String password = "Amphicoelias1"; // replace with your Oracle password (default: eecsclass)
